      ...
      <Col className="lg:flex mt-10">
        <Col className="p-5 xl:px-10">
          ...
          {stats.map(({ icon, title, value }) => (
            <Col className="flex items-center justify-between text-base my-3 lg:text-lg" key={value + title}>
      ...
      <Col className="lg:flex lg:justify-between p-5">
        ...
        <Col className="flex-shrink-0 lg:w-5/12">
          ...
          {cryptoDetails?.links?.map((link) => (
            <Row className="flex items-center justify-between gap-x-8" key={link.name}>
